...
HT_API HT_Boolean ht_registry_register_feature(uint32_t feature_id, HT_FeatureDisableCallback disable_callback);

HT_API HT_EventType ht_registry_register_event_klass(HT_EventKlass* event_klass);
